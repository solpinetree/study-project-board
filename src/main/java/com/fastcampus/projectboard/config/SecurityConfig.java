...
//    }
    ...
    // user 정보를 연결, Principal : 인증과 관련된 정보
    @Bean
     ...
     *
     * <p>
     * TODO: 카카오 도메인에 결합되어 있는 코드. 확장을 고려하면 별도 인증 처리 서비스 클래스로 분리하는 것이 좋지만, 현재 다른 OAuth 인증 플랫폼을 사용할 예정이 없어 이렇게 마무리 한다.
     *
    ...
    // spring security 를 이용할 때는 반드시 passwordEncoder를 설정해줘야 한다.
    @Bean
